# 🎯 Prompts d'activation des agents NEXUS

> Modèles de prompts prêts à l'emploi pour activer n'importe quel agent au sein du pipeline NEXUS. Copiez, personnalisez les `[PLACEHOLDERS]`, et déployez.

---

## Contrôleur de pipeline

### Agents Orchestrator — Pipeline complet
```
...
### Agents Orchestrator — Boucle Dev↔QA
```
...
### Evidence Collector — QA de tâche
```
...
### Reality Checker — Intégration finale
```
...
| Situation | Prompt principal | Prompts de support |
|-----------|---------------|-----------------|
| Démarrer un nouveau projet | Orchestrator — Pipeline complet | — |
| Construire une fonctionnalité | Orchestrator — Boucle Dev↔QA | Developer + Evidence Collector |
| Corriger un bug | Backend/Frontend Developer | API Tester ou Evidence Collector |
| Lancer une campagne | Content Creator | Social Media Strategist + agents de plateforme |
| Préparer un lancement | Voir le playbook phase 5 | Tous les agents marketing + DevOps |
| Reporting mensuel | Executive Summary Generator | Analytics Reporter + Finance Tracker |
| Réponse aux incidents | Infrastructure Maintainer | DevOps Automator + développeur concerné |
| Recherche de marché | Trend Researcher | Analytics Reporter |
| Audit de conformité | Legal Compliance Checker | Executive Summary Generator |
| Problème de performance | Performance Benchmarker | Infrastructure Maintainer |
